    ...
    <b-row no-gutters class="mb-3">
      <b-col class="bg-dark">
        <b-navbar toggleable="md" type="dark" variant="dark">
          ...
          <b-navbar-brand href="/">X-Pub</b-navbar-brand>
          <b-collapse is-nav id="nav_collapse">
            <b-navbar-nav>
              <b-nav-item class="text-white" :to="'/FX'">{{$t('FX.plural')}}</b-nav-item>
              <b-nav-item class="text-white" :to="'/deals'">{{$t('deals.plural')}}</b-nav-item>
            </b-navbar-nav>
