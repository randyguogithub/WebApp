  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'An innovation  tool for simulating deal input from PTS to TREATS.  Currently support FX, more products are coming!' }
    ],
    link: [
